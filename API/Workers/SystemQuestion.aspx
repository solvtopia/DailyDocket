<%@ Page Title="DailyDocket.CommonCore &gt; Objects &gt; SystemQuestion" Language="vb" AutoEventWireup="false" MasterPageFile="~/masterPages/InformationPopUp.master" CodeBehind="SystemQuestion.aspx.vb" Inherits="DailyDocket.API._SystemQuestion" %>
